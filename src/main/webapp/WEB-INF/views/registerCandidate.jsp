...
<div class="container-wrapper">
    <div class="container">
        ...
        <form:form action="${pageContext.request.contextPath}/registerCan" method="post"
        ...
        <div class="form-group">
            ...
            <form:input path="candidateEmail" id="email" class="form-Control" required="required" data-error="Please enter your Email."/>
        </div>

        <div class="form-group">
            <label for="phone">Phone</label>
            <form:input path="candidatePhone" id="phone" class="form-Control" required="required" data-error="Please enter your Phone."/>
        </div>
